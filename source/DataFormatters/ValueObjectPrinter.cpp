...
bool ValueObjectPrinter::UpdateShouldPrint() {
  return m_options.m_flat_output == false || m_type_flags.Test(eTypeHasValue);
}

bool ValueObjectPrinter::UpdateIsNil() { return m_valobj->IsNilReference(); }

bool ValueObjectPrinter::UpdateIsUnit() {
  return m_valobj->IsUninitializedReference();
}

bool ValueObjectPrinter::UpdateIsPtr() {
  return m_type_flags.Test(eTypeIsPointer);
}

bool ValueObjectPrinter::UpdateIsRef() {
  return m_type_flags.Test(eTypeIsReference);
}

bool ValueObjectPrinter::UpdateIsAggregate() {
  return m_type_flags.Test(eTypeHasChildren);
}

bool ValueObjectPrinter::UpdateIsInstancePtr() {
